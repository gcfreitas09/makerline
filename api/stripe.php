...
function load_stripe_config()
{
    ...
    if (!file_exists($file)) {
        if (is_array($env)) {
            ...
            $config = [
                ...
                'partner_connect_accounts' => is_array($env['partner_connect_accounts'] ?? null) ? $env['partner_connect_accounts'] : [],
    ...
    $config = [
        ...
        'partner_connect_accounts' => is_array($data['partner_connect_accounts'] ?? null) ? $data['partner_connect_accounts'] : [],
